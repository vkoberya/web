            ...
            return array(
                ...
                'params'      => array(
                    ...
                    array(
                        ...
                        'param_name' => 'class',
                        'value' => esc_html__( 'process-standard-area text-center bg-gradient text-light default-padding' , 'solion' ),
                        'admin_label' => false,
                        'weight' => 0,
                        'group' => 'General',
                    ),
            ...
            extract(
                shortcode_atts(
                    array(
                        'title' => '',
                        'sub' => '',
                        'class' => 'process-standard-area text-center bg-gradient text-light default-padding',
