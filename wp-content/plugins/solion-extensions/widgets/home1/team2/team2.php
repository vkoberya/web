...
/**
* Adds new shortcode "home1-team2-section-shortcode" and registers it to
    ...
    class team2_section {
        ...
        */
        public function __construct() {
            ...
            add_shortcode( 'home1-team2-section-shortcode', array( 'team2_section', 'output' ) );

            // Map shortcode to Visual Composer
            if ( function_exists( 'vc_lean_map' ) ) {
                vc_lean_map( 'home1-team2-section-shortcode', array( 'team2_section', 'map' ) );
            }
    ...
    * This is an array of all your settings which become the shortcode attributes ($atts)
        ...
        */
        public static function map() {
            return array(
                'name'        => esc_html__( 'Team2 Section', 'solion' ),
                'description' => esc_html__( 'Home1 - team2 Section', 'solion' ),
                'base'        => 'vc_infobox',
                ...
                'params'      => array(
                    ...
                    array(
                        ...
                        'value' => esc_html__( 'https://creativedigital.tech/solionwordpress/team2-single/', 'solion' ),
