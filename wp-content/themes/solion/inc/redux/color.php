...
function solion_customize_css() { 
    global $solion_options; if ($solion_options['main_color_solion'] == 7) {
?>
	<style>
		:root {
  --default-color: <?php echo esc_html($solion_options['colorcode']); ?>;
}
...
.bg-gradient {
  background: linear-gradient(90deg, <?php echo esc_html($solion_options['color-gra']['from']); ?> 0%, <?php echo esc_html($solion_options['color-gra']['to']); ?> 56%);
}
...
.about-area .info .progress-box .progress .progress-bar {
  background: linear-gradient(90deg, <?php echo esc_html($solion_options['color-gra']['from']); ?> 0%, <?php echo esc_html($solion_options['color-gra']['to']); ?> 100%);
}
...
add_action('wp_head', 'solion_customize_css');
}
?>