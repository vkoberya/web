...
<?php }?>
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h2><?php esc_html_e('Search Results For : ','solion' ); echo get_search_query(); ?></h2>
                <ul class="breadcrumb">
                    <li><a href="<?php echo esc_url(home_url('/')); ?>"><i class="fas fa-home"></i> <?php esc_html_e( 'Home', 'solion' )?></a></li>
                    <li class="active"><?php esc_html_e( 'Search Results', 'solion' )?></li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="blog-area full-blog blog-standard full-blog default-padding">
    ...
    <h2><?php esc_html_e( 'Nothing Found', 'solion' ) ;?></h2>
    <p><?php
            // If no content, include the "No posts found" template.
            esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'solion' ) ;?></p>
            <div class="sidebar-item search">
    <div class="sidebar-info">
        <form role="search" method="get" action="<?php echo esc_url(home_url('/')); ?>">
            <input type='search' name="s" placeholder="<?php esc_attr_e( 'Search Here...', 'solion' )?>" class="form-control search-fix" id="search-box" value="<?php the_search_query(); ?>" >
